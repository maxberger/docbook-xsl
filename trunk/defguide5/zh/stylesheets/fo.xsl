...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version='1.0'>
  ...
  -->
  <xsl:param name="title.font.family">Arial,sans-serif,SimHei</xsl:param>
  <xsl:param name="body.font.family">Times New Roman,serif,SimSun</xsl:param>
  <xsl:param name="sans.font.family">Arial,sans-serif,SimHei</xsl:param>
  <xsl:param name="dingbat.font.family">Times New Roman,serif,SimSun</xsl:param>
  ...
  <xsl:param name="title.fontset">Arial,sans-serif,OpenSymbol,Symbol,ZapfDingbats,SimHei</xsl:param>
  <xsl:param name="body.fontset">Times New Roman,serif,OpenSymbol,Symbol,ZapfDingbats,SimSun</xsl:param>
